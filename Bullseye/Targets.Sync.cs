namespace Bullseye
{
    ...
    public partial class Targets
    {
        ...
        /// If the entry assembly is <c>null</c>, the default prefix of "Bullseye" is used.
        /// </param>
        public static void RunTargetsWithoutExiting(IEnumerable<string> targets, IEnumerable<(string, bool)> options, Func<Exception, bool> messageOnly = null, string logPrefix = null) =>
        ...
        /// If the entry assembly is <c>null</c>, the default prefix of "Bullseye" is used.
        /// </param>
        public static void RunTargetsAndExit(IEnumerable<string> targets, IEnumerable<(string, bool)> options, Func<Exception, bool> messageOnly = null, string logPrefix = null) =>
        ...
        /// If the entry assembly is <c>null</c>, the default prefix of "Bullseye" is used.
        /// </param>
        public void RunWithoutExiting(IEnumerable<string> targets, IEnumerable<(string, bool)> options, Func<Exception, bool> messageOnly = null, string logPrefix = null) =>
            this.targetCollection.RunAsync(targets, options, messageOnly, logPrefix).GetAwaiter().GetResult();
        ...
        /// If the entry assembly is <c>null</c>, the default prefix of "Bullseye" is used.
        /// </param>
        public void RunAndExit(IEnumerable<string> targets, IEnumerable<(string, bool)> options, Func<Exception, bool> messageOnly = null, string logPrefix = null) =>
            this.targetCollection.RunAndExitAsync(targets, options, messageOnly, logPrefix).GetAwaiter().GetResult();
    }
}
