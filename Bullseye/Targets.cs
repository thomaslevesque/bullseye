namespace Bullseye
{
    ...
    public partial class Targets
    {
        ...
        /// </param>
        /// <returns>A <see cref="Task"/> that represents the asynchronous running of the targets.</returns>
        public Task RunWithoutExitingAsync(IEnumerable<string> targets, IEnumerable<(string, bool)> options, Func<Exception, bool> messageOnly = null, string logPrefix = null) =>
            this.targetCollection.RunAsync(targets, options, messageOnly, logPrefix);
        ...
        /// </param>
        /// <returns>A <see cref="Task"/> that represents the asynchronous running of the targets.</returns>
        public Task RunAndExitAsync(IEnumerable<string> targets, IEnumerable<(string, bool)> options, Func<Exception, bool> messageOnly = null, string logPrefix = null) =>
            this.targetCollection.RunAndExitAsync(targets, options, messageOnly, logPrefix);
    }
}
